    ...
    return AppScaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(l10n.privacyPolicyContent, style: theme.textTheme.bodyMedium),
            20.height,
            AppTitleText(title: l10n.privacyPolicyTitle1),
            Text(l10n.privacyPolicyContent1, style: theme.textTheme.bodyMedium),
            20.height,
            AppTitleText(title: l10n.privacyPolicyTitle2),
            Text(l10n.privacyPolicyContent2, style: theme.textTheme.bodyMedium),
            20.height,
            AppTitleText(title: l10n.privacyPolicyTitle3),
            Text(l10n.privacyPolicyContent3, style: theme.textTheme.bodyMedium),
            20.height,
